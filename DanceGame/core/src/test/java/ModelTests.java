...
/*
    ...
    */
    ...
    public void turnNumberIncreases(){
        int initialTurnNumber = model.turnNumber;
        model.changeWhichPlayersTurnItIs();
        int updatedTurnNumber = model.turnNumber;
    ...
    public void endTurnMakesNextPlayersTurnNotStarted() {
        boolean isTurnStarted = model.hasPlayerStartedTheirTurn;
        model.playerConfirmedDanceMove();
        boolean updatedIsTurnStarted = model.hasPlayerStartedTheirTurn;
    ...
    */
    ...
    public void addADancefan() {
        ...
        Type tileType = model.previewDanceFloor.getType(oneStepLeftOfMainDancer);
        Color tileColor = model.previewDanceFloor.getColor(oneStepLeftOfMainDancer);
        ...
        model.addDanceFansFromPattern(danceMovePattern);

        //Check that a dancefan was actually added to the dancefloor
        Type updatedTileType = model.previewDanceFloor.getType(oneStepLeftOfMainDancer);
        Color updatedTileColor = model.previewDanceFloor.getColor(oneStepLeftOfMainDancer);
    ...
    public void gameEndsAfterMaximumTurnsLimit(){
        ...
        assertEquals(model.gameIsDone(), true );
    }
